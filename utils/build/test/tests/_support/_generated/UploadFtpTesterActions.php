<?php  //[STAMP] e74a9978053997eebe2e1b852d461602
...
trait UploadFtpTesterActions
{
     ...
     *
     *
     * @see \Helper\Acceptance::saveHtml()
     */
    public function saveHtml($name) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('saveHtml', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Acceptance::setConfigUrl()
     */
    public function setConfigUrl($url) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('setConfigUrl', func_get_args()));
    }
