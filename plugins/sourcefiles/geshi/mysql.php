...
$language_data = array (
    ...
    'URLS' => array(
        1 => 'https://search.oracle.com/search/search?group=MySQL&amp;q={FNAME}',
        2 => 'https://search.oracle.com/search/search?group=MySQL&amp;q={FNAME}',
        3 => 'https://search.oracle.com/search/search?group=MySQL&amp;q={FNAME}',
        4 => 'https://search.oracle.com/search/search?group=MySQL&amp;q={FNAME}',
        5 => 'https://search.oracle.com/search/search?group=MySQL&amp;q={FNAME}',
        6 => 'https://search.oracle.com/search/search?group=MySQL&amp;q={FNAME}',
        7 => 'https://search.oracle.com/search/search?group=MySQL&amp;q={FNAME}',
        8 => 'https://search.oracle.com/search/search?group=MySQL&amp;q={FNAME}',
        9 => 'https://search.oracle.com/search/search?group=MySQL&amp;q={FNAME}',
