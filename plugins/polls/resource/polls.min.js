...
a.find(".poll-star").each(function(){c>=b(this).attr("data-vote")&&b(".fa-star-o",this).removeClass("fa-star-o").addClass("fa-star")})}});b(e).ready(function(){d.polls=new d.Polls})})(jQuery,document,litepubl);
