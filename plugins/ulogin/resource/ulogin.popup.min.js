...
d=c.parsetml(this.tml_data,{redirurl:encodeURIComponent(ltoptions.url+this.url+(d?encodeURIComponent(d):"")),callback:""});b.attr("data-ulogin",d);this.initOnReady(b.attr("id"))}},initOnReady:function(a){var b=this;this.ready(function(){b.status="script";uLogin.setStateListener(a,"ready",function(){b.status="ready"});uLogin.customInit(a);c("[data-uloginbutton]","#"+a).attr("role","button");uLogin.setStateListener(a,"open",function(){b.status="open"});uLogin.setStateListener(a,"close",function(){b.status=
