(function(b,f,g){b(f).ready(function(){litepubl.ulogin=new litepubl.Ulogin});litepubl.Ulogin=Class.extend({registered:!1,logged:!1,script:!1,dialog:!1,html:'<div><p>%%lang.subtitle%%</p><div id="ulogin-dialog"><div id="ulogin-holder" data-ulogin="display=small;fields=first_name,last_name;optional=email,phone,nickname;providers=vkontakte,odnoklassniki,mailru,yandex,facebook,google,twitter;hidden=other;redirect_uri=%%redirurl%%;%%callback%%"></div></div><div><a href="%%url%%" id="email-login">%%lang.emaillogin%%</a></div></div>',
init:function(){this.registered=litepubl.getuser().pass?1:0;if(!this.registered){var a=this;b(f).on("click.ulogin",'a[href^="'+ltoptions.url+'/admin/"], a[href^="/admin/"]',function(){var c=b(this).attr("href");litepubl.is_admin_url(c)&&a.open(c);return!1});b("#ulogin-comment-button").click(function(){a.onlogged({type:"get",method:"comments_get_logged",params:{idpost:ltoptions.idpost},callback:function(a){b("#before-commentform").html(a)},error:function(a,d){b.errobox(a)}});return!1})}},open:function(a){if(this.dialog)return!1;
a=b.extend({url:ltoptions.url+"/admin/login/?backurl="+encodeURIComponent(location.href),callback:!1,email:function(){g.location=a.url}},a);var c=this;c.ready(function(){c.dialog=!0;var d=lang.ulogin,e=c.html.replace(/%%lang.emaillogin%%/gim,d.emaillogin).replace(/%%lang.subtitle%%/gim,d.subtitle).replace(/%%url%%/gim,a.url);b.isFunction(a.callback)?(e=e.replace(/%%callback%%/gim,"callback=ulogincallback").replace(/%%redirurl%%/gim,""),g.ulogincallback=function(c){b.closedialog();try{a.callback(c),
