...
this.holder=!1;c.stat("photoswipe_closed")},getitems:function(a,d){var c=[],k=this.getoptions();k.galleryUID=parseInt(a);var h=768>=b(window).width(),l=this.animatethumbs;this.links.each(function(m){var e=b(this);if(a==e.data("idpost")){var f=e.data("file"),g=e.data("midle");d==f.id&&(k.index=c.length);h&&g?c.push({src:g.link,msrc:l?b("img",e).attr("src"):!1,w:parseInt(g.width),h:parseInt(g.height),title:e.attr("title"),pid:parseInt(f.id),linkindex:m}):c.push({src:e.attr("href"),msrc:l?b("img",e).attr("src"):
!1,w:parseInt(f.width),h:parseInt(f.height),title:e.attr("title"),pid:parseInt(f.id),linkindex:m})}});return c},openimage:function(a){if(!this.ready)return this.load_script(b.proxy(this.openimage,this,a));var d=this.getoptions();this.options=b.extend({index:0,history:!1,galleryPIDs:!1,shareEl:!1,counterEl:!1,arrowEl:!1,showHideOpacity:!0,getThumbBoundsFn:!1},this.options);this.openitems([{src:a.url,w:a.width,h:a.height,title:a.title}]);this.options=d},get_hash:function(){var a=decodeURI(window.location.hash.substring(1));
...
function(){c.stat("photoswipe_afterChange",{index:a.getCurrentIndex(),linkindex:a.currItem.linkindex,idimage:a.currItem.pid})});a.listen("shareLinkClick",function(a,b){c.stat("photoswipe_shareLinkClick",{url:b.href})})}});b(h).ready(function(){c.photoswipe=new c.photoswipePlugin(b(".photo"))})})(jQuery,litepubl,document);
