...
class Page extends \litepubl\core\Events implements \litepubl\view\ViewInterface
{
    ...
    public function createForm()
    {
        ...
        return strtr(
            $theme->templates['content.admin.form'],
            ['$formtitle' => $lang->pwdaccess, '$items' => $theme->getinput('password', 'password', '', $lang->password) . $theme->getinput('checkbox', 'remember', '$remember', $lang->remember) . $theme->getinput('hidden', 'antispam', '$antispam') ,
