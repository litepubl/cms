...
a.button_text_top_padding=1,a.button_text_left_padding=5);try{this.onsettings(a),this.swf=new SWFUpload(a)}catch(g){alert("Error create swfupload "+g.message)}},addparam:function(b,a){this.swf.addPostParam(b,a)}})})(jQuery,litepubl,window);
