...
this.items&&(a.previewlink=ltoptions.files+"/files/"+this.items[a.preview].filename));return d.parsetml(this.tml.item,{id:a.id,toolbar:this.tml.toolbar,content:d.parsetml(this.tml[b],a)})},init_uploader:function(){this.uploader=new e.Uploader;this.uploader.onupload.add(d.proxy(this.uploaded,this))},uploaded:function(a){try{var b=a.id;this.items[b]=a.item;parseInt(a.item.preview)&&(this.items[a.preview.id]=a.preview);parseInt(a.item.midle)&&(this.items[a.midle.id]=a.midle);this.add(b)}catch(c){e.onerror(c)}},
