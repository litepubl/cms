...
error:c.proxy(d.error,d)}).always(function(){b.prop("disabled",!1)})},confirm:function(a){var b=this;c.confirmbox(lang.dialog.confirm,lang.comment.checkspam,lang.comment.robot,lang.comment.human,function(d){1==d&&c.jsonrpc({type:"get",method:"comment_confirm",params:{confirmid:a},callback:c.proxy(b.success,b),error:c.proxy(b.error,b)})})},success:function(a){if("cookies"in a)for(var b in a.cookies)set_cookie(b,a.cookies[b]);e.location=a.posturl},submit:function(){try{if(!this.validate())return!1;
if(ltoptions.theme.comments.confirmcomment)return this.send(),!1}catch(a){erralert(a)}}});c(f).ready(function(){ltoptions.theme.comments.form.length&&(litepubl.confirmcomment=new litepubl.class_confirmcomment)})})(jQuery,document,window);
