(function(a,l,m){a.BootstrapDialog=Class.extend({dialog:!1,footer:!1,style:!1,options:!1,padwidth:32,padheight:0,removeOnclose:!0,tml:'<div class="modal fade" id="dialog-%%id%%" tabindex="-1" role="dialog" aria-labelledby="modal-title-%%id%%"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="%%close%%"><span aria-hidden="true">&times;</span><span class="sr-only">%%close%%</span></button><h4 class="modal-title" id="modal-title-%%id%%">%%title%%</h4></div><div class="modal-body">%%body%%</div><div class="modal-footer">%%buttons%%</div></div></div></div>',
...
success:"check",danger:"times-circle",error:"times-circle"};a in c&&(a=c[a]);return'<span class="fa fa-'+a+'"></span>'}});a.ready2(function(){"modal"in a.fn&&(a.bootstrapDialog=new a.BootstrapDialog)})})(jQuery,window,document);
