(function(c,f,d){d.bootstrap=d.bootstrap||{};d.bootstrap.Tabs=Class.extend({init:function(){var a=this;c(f).on("show.bs.tab",function(b){b=c(b.target);a.before(b);a.event("before",b)}).on("shown.bs.tab",function(b){a.event("activated",c(b.target))});a=this;this.navtabs(c(c(".admintabs>.nav-tabs").toArray().reverse()))},tabs:function(a,b){this.navtabs(a.children(".nav-tabs"));b&&a.data("tabevents.litepubl",b)},navtabs:function(a){return a.each(function(){var a=c(this);a.children(".active").length||
...
on:function(a,b){a.data("tabevents.litepubl",b)},off:function(a){a.data("tabevents.litepubl",!1)},event:function(a,b){var c=b.closest("ul").parent().data("tabevents.litepubl");if(c&&a in c)c[a](this.getpanel(b))}});c(f).ready(function(){d.tabs=new d.bootstrap.Tabs})})(jQuery,document,litepubl);
