...
this.options.parent+'"]').each(c.proxy(function(a,b){var d=c(b);this.addAriaAndCollapsedClass(k(d),d)},this)).end()};d.prototype.addAriaAndCollapsedClass=function(a,b){var c=a.hasClass("in");a.attr("aria-expanded",c);b.toggleClass("collapsed",!c).attr("aria-expanded",c)};var l=c.fn.collapse;c.fn.collapse=g;c.fn.collapse.Constructor=d;c.fn.collapse.noConflict=function(){c.fn.collapse=l;return this};c(h).ready(function(){c(h).on("click.bs.collapse.data-api",'[data-toggle="collapse"]',function(a){var b=
c(this);b.attr("data-target")||a.preventDefault();a=k(b);b=a.data("bs.collapse")?"toggle":b.data();g.call(a,b)})})}(jQuery,document);
