...
a||"error"==a)b.extra.ended=new Date;c.on[a](d,b);"loadend"==a&&e()}});f[d](b)}}})}else d()}function K(){var a=w("onmessage = function(e) { postMessage(!!FileReaderSync); };");a&&(a.onmessage=function(a){t=a.data},a.postMessage({}))}function e(){}function p(a,b){for(var c in b)b[c]&&b[c].constructor&&b[c].constructor===Object?(a[c]=a[c]||{},p(a[c],b[c])):a[c]=b[c];return a}function E(a,b){return(new RegExp("(?:^|\\s+)"+b+"(?:\\s+|$)")).test(a.className)}function C(a,b){E(a,b)||(a.className=a.className?
[a.className,b].join(" "):b)}function A(a,b){E(a,b)&&(a.className=a.className.replace(new RegExp("(?:^|\\s+)"+b+"(?:\\s+|$)","g")," ").replace(/^\s\s*/,"").replace(/\s\s*$/,""))}var D=f.FileReader,t=!1,J="loadstart progress load abort error loadend".split(" "),v=!1,l=f.FileReaderJS={enabled:!1,setupInput:y,setupDrop:z,setupClipboard:x,setSync:function(a){(v=a)&&!t&&K()},getSync:function(){return v&&t},output:[],opts:{dragClass:"drag",accept:!1,readAsDefault:"BinaryString",readAsMap:{},on:{loadstart:e,
